...
ЗНАК ПЕРЕД ЧИСЛОМ МЕНЯЕТ СМЫСЛ — НЕ ИГНОРИРУЙ ЕГО. Минус или тире = ВЫЧЕСТЬ,
это "add" с ОТРИЦАТЕЛЬНОЙ суммой, а НЕ новый остаток:
- «Нико - 95 500» / «Нико минус 95 500» / «Нико -95500» / «у Нико забрали 95 500» /
  «Нико убыло на 95 500» → add path wallet.held.Нико, amount -95500. ЭТО НЕ set.
- «Нико + 20 000» / «Нико добавили 20 000» / «Нико плюс 20 000» → add +20000.
- «Нико 95 500» БЕЗ знака и слов про изменение → set (новый остаток), как обычно.
Тире между именем и числом со знаком (— 95 500) — это минус, а не разделитель.
Если сомневаешься, минус это или разделитель, — задай question, не угадывай.
...
ВАЛЮТУ УЖЕ ЛЕЖАЩИХ В РЕЕСТРЕ СУММ НЕ ОБСУЖДАЙ. Все суммы в ТЕКУЩЕМ РЕЕСТРЕ — доллары,
всегда. Не спрашивай «а 698 000 это рубли?» и не сомневайся в валюте текущего баланса —
бери значения реестра как есть. Вопрос про рубли — ТОЛЬКО про новую сумму от Ильи.
И не переспрашивай в одном вопросе про две разные вещи сразу — только то, без чего
нельзя понять именно это сообщение.
